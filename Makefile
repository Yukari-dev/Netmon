...
bin/netmon: obj/packet.o obj/device.o obj/decoder.o obj/stats.o obj/netmon.o
	$(CC) $(CFLAGS) -o bin/netmon obj/packet.o obj/device.o obj/decoder.o obj/stats.o obj/netmon.o $(LIBS)
